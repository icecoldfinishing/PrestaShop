  ...
  <div class="auth-container d-flex align-items-center justify-content-center py-5">
    <div class="card auth-card shadow-lg border-0 overflow-hidden">
      <div class="row g-0 h-100">
        <!-- Decoration side -->
        <div class="col-md-5 bg-primary d-none d-md-flex align-items-center justify-content-center text-white p-4 text-center">
          <div>
...
const handleLogin = async () => {
  ...
  try {
    const customer = await psLoginCustomer(credentials.value.email, credentials.value.password);
